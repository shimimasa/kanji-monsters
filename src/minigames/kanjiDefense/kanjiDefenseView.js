...
@media(max-height:430px) and (min-width:581px){#kanjiDefenseScreen .kd-main{grid-template-columns:minmax(0,1fr) 90px}.kd-board{height:170px}.kd-companion canvas{width:90px;height:45px}.kd-result{padding:6px}.kd-word-columns{display:none}}
