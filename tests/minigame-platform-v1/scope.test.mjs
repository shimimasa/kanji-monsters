...
test('product behavior, Host, registry, title, adapters, and seven game sources are unchanged', () => {
  const paths = [
    'src/minigames/miniGameHost.js', 'src/minigames/registry.js',
...
test('Host remains generic and all game sources own no continuous scheduler or direct Storage', () => {
  ...
  for (const gameId of ['mathInvader', 'englishChoice', 'sentenceOrder', 'timedChoice', 'multiSelect', 'asyncChoice']) {
