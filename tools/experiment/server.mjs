...
import { args, BASELINE, TAG, git, hash, canonical, baselineCore, inside } from './common.mjs';
...
export async function startLab(options) {
  ...
  if (git(experiment,'diff','--name-only',BASELINE,'--','src','public','package.json','package-lock.json','index.html','style.css','vite.config.js','firebase.json','vercel.json')) throw Error('STOP E0 product changes');
