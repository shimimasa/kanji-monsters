...
(() => {
  ...
  EventTarget.prototype.addEventListener=function(type,callback,options) {
    ...
    if(callback&&new Error().stack.includes('babylonGLBRenderer-')&&!registrations.some(r=>!r.removed&&r.target.deref()===this&&r.callback.deref()===callback&&r.type===type&&r.capture===capture)) {
