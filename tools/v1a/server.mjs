...
export async function startLab(options) {
  ...
  if(changed.some(p=>!allowed.has(p)&&!p.startsWith('src/visuals/')&&p!=='public/assets/3d/monsters/HKD-E01/HKD-E01.v1a.1.glb')) throw Error('STOP V1a protected source changes: '+changed);
